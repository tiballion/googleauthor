...
export const BookItem = ({ book }: BookItemProps) => {
  return (
    <>
      <div
        className="h-80 p-2 bg-zinc-800 hover:overflow-scroll rounded-md flex flex-col justify-between items-center cursor-pointer border border-gray-700 hover:border-indigo-500"
